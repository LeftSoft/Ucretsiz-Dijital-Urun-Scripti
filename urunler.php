...
$kategorisor->execute();
  ...
  <ul class="pagination justify-content-center">
   ...
   <?php
    ...
    <li class="page-item active"><a class="page-link" onclick="javascript:location.href='<?php echo $ayarcek['ayar_url']; ?>urunler?sayfa=<?php echo $s; ?>';"><?php echo $s; ?></a>

    </li>
     <?php } else {?>

    <li class="page-item"><a class="page-link" onclick="javascript:location.href='<?php echo $ayarcek['ayar_url']; ?>urunler?sayfa=<?php echo $s; ?>';"><?php echo $s; ?></a></li>
     <?php   }
