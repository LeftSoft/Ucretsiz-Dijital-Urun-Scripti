...
if (isset($_POST['keyekle'])) {
   if (empty($_SESSION['kullanici_mail'])) {
        Header("Location: admin/giris.php");
        exit;
    }
    
  $degisken = $_POST['key_text'];
$bolunmus = explode(",", $degisken);

  $ayarkaydet=$db->prepare("INSERT INTO anahtar SET
    urun_id=:urun_id,
    key_text=:key_text
    ");
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputName">Toplu Key Ekle</label>
                <input type="text" id="inputName" class="form-control" name="key_text" required="" placeholder="Örnek: key1,key2,key3">
              </div>
            <input type="hidden" name="urun_id" value="<?php echo $uruncek['urun_id']; ?>">
               <div class="form-group">
             <div class="col-12">
              <a href="key-listele" class="btn btn-secondary">Geri</a>
         <button type="submit" name="keyekle" class="btn btn-success float-right">Key Ekle</button>
        </div>
      </div>
            </div>
            <!-- /.card-body -->
